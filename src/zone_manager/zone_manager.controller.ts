...
export class ZoneManagerController {
  constructor(
    private readonly service: ZoneManagerService,
  ...
  @ApiBody({
    ...
    schema: {
      example: {
        profileId: 'f88c9e79-66b0-4d3b-968a-7df22bdaee50',
        regionIds: ['3ffb3715-0f31-47cb-b2a8-d62bb36f2ce9'],
  ...
  @ApiOperation({
    description: 'Fetch All Service Schedules that fall under Zone Manager',
  })
  ...
  @ApiOperation({
    description: 'Fetch All Service Bookings that fall under Zone Manager',
  })
  @ApiBearerAuth('acccess-token')
  @ApiQuery({ name: 'page', required: false })
  @ApiQuery({ name: 'limit', required: false })
  ...
  @ApiOperation({
    description: 'Fetch All Meetings that fall under Zone Manager',
  })
  @ApiBearerAuth('acccess-token')
  @ApiQuery({ name: 'page', required: false })
  @ApiQuery({ name: 'limit', required: false })
