...
export class ClientController {
  ...
  @ApiResponse({
    status: 200, description: 'Booked services fetched successfully', schema: {
      example: {
        "status": "success",
  ...
  @ApiResponse({
    status: 200, description: 'Booked service details', schema: {
      example: {
        "status": "success",
        "message": "Request successful",
        "data": {
  ...
  @ApiParam({ name: 'id', description: 'Booked service ID' })
  @ApiResponse({
    status: 200, description: 'Service cancelled successfully', schema: {
      example: {
        "status": "success",
  ...
  @ApiResponse({
    status: 200, description: 'Schedules fetched successfully',
    schema: {
      example: {
        "status": "success",
        "message": "Request successful",
  ...
  @ApiParam({ name: 'id', description: 'Schedule ID' })
  @ApiResponse({
    status: 200, description: 'Schedule cancelled', schema: {
      example:
      {
        "status": "success",
  ...
  @ApiParam({ name: 'id', description: 'Meeting ID' })
  @ApiResponse({
    status: 200, description: 'Meeting cancelled', schema: {
      example: {
        "status": "success",
  ...
  @ApiResponse({
    status: 200, schema: {
      example: {
        ...
        "data": {
          "id": "08eb5dfb-d9cd-412f-b6eb-a25e4509edc4",
          "profile_image": "https://dev-palqar-bucket.s3.ap-south-1.amazonaws.com/uploads/clients/profile/1768038282936-nbqt80yispl.png"
        }
      }
    }
  })
  ...
  @ApiResponse({
    status: 200, description: 'Profile image deleted', schema: {
      example: {
        "status": "success",
