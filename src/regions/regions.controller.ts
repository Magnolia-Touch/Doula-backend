...
export class RegionController {
    ...
    @ApiResponse({ status: 200, type: SwaggerResponseDto, schema: { example: { success: true, message: 'Region updated', data: { id: 'region-1' } } } })
    @Put(':id')
    ...
    @ApiParam({ name: 'id' })
    @ApiResponse({ status: 200, type: SwaggerResponseDto, schema: { example: { success: true, message: 'Region deleted', data: null } } })
    @Delete(':id')
