...
CREATE TABLE `EnquiryForm` (
    ...
    `meetingsTimeSlots` VARCHAR(191) NOT NULL,
    `seviceStartDate` DATETIME(3) NOT NULL,
    `serviceEndDate` DATETIME(3) NOT NULL,
    `VisitFrequency` INTEGER NOT NULL,
    `serviceTimeSlots` VARCHAR(191) NOT NULL,
...
CREATE TABLE `AvailableSlotsForMeeting` (
    ...
    UNIQUE INDEX `AvailableSlotsForMeeting_doulaId_weekday_key`(`doulaId`, `weekday`),
    UNIQUE INDEX `AvailableSlotsForMeeting_adminId_weekday_key`(`adminId`, `weekday`),
    UNIQUE INDEX `AvailableSlotsForMeeting_zoneManagerId_weekday_key`(`zoneManagerId`, `weekday`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `AvailableSlotsForService` (
    ...
    UNIQUE INDEX `AvailableSlotsForService_doulaId_weekday_key`(`doulaId`, `weekday`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
